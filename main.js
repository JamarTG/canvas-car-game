...
const gameOverAnimation = () => {
    ...
    canvasContext.fillText(` Score: ${userCar.getScore()}`, 60, canvas.height / 2 + 200);
    canvasContext.fillStyle = "#55FF33";
    canvasContext.font = '15px "Press Start 2P", sans-serif';
    canvasContext.fillText(" PRESS 'ENTER' TO RESTART", 60, canvas.height / 2 + 50);
...
const gameStartAnimation = () => {
    ...
    backgroundImg.onload = () => {
        ...
        canvasContext.fillStyle = "#55FF33";
        canvasContext.font = '15px "Press Start 2P", sans-serif';
        canvasContext.fillText("PRESS 'ENTER' TO START CAR", (canvas.width / 20) * 3, canvas.height / 3 - 50);
